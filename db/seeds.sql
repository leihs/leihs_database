...
--
-- Data for Name: ar_internal_metadata; Type: TABLE DATA; Schema: public; Owner: nitaai
--
...
--
-- Data for Name: audited_changes; Type: TABLE DATA; Schema: public; Owner: nitaai
--

COPY public.audited_changes (id, txid, tg_op, table_name, before, after, changed, created_at) FROM stdin;
\.
...
COPY public.users (id, login, firstname, lastname, phone, org_id, email, badge_id, address, city, zip, country, language_id, settings, delegator_user_id, created_at, updated_at, account_enabled, password_sign_in_enabled, url, img256_url, img32_url, img_digest, is_admin, extended_info, searchable, secondary_email, language_locale) FROM stdin;
\.
...
--
-- Data for Name: audits; Type: TABLE DATA; Schema: public; Owner: nitaai
--
...
COPY public.mail_templates (id, inventory_pool_id, language_id, name, format, body, created_at, updated_at, is_template_template, type, language_locale) FROM stdin;
\.
