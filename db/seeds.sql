...
INSERT INTO public.fields (id, active, "position", data, dynamic) VALUES ('model_id', true, 2, '{"type": "autocomplete-search", "group": null, "label": "Model", "required": true, "attribute": ["model", "id"], "form_name": "model_id", "value_attr": "id", "permissions": {"role": "lending_manager", "owner": true}, "search_attr": "search_term", "search_path": "models", "target_type": "item", "display_attr": "product", "display_attr_ext": "version", "item_value_label": ["model", "product"], "item_value_label_ext": ["model", "version"]}', false);
