...
INSERT INTO public.fields (id, active, "position", data, dynamic) VALUES ('inventory_pool_id', true, 21, '{"type": "autocomplete", "group": "Inventory", "label": "Responsible department", "values": "all_inventory_pools", "required": true, "attribute": ["inventory_pool", "id"], "forPackage": true, "permissions": {"role": "inventory_manager", "owner": true}}', false);
